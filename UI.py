...
class MyFrame(wx.Frame):
    def __init__(self):
        ...
        # Create a text control for user input (ratio target)
        ...
        self.custom_text_ctrl.SetHint("Enter compression ratio target")
    ...
    def on_select_directory(self, event):
        #handle directory selection popout
    ...
    def on_compress(self, event):
        #determines what the compress button does
